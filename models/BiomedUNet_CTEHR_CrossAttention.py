...
class CTEHRCrossAttention(nn.Module):
    ...
    def __init__(
        ...
        # Convert one clinical embedding vector into several clinical tokens.
        # Important: one token only would make cross-attention almost degenerate.
        ...
        # Start close to image-only model.
        # This prevents random clinical attention from destroying useful image features
    ...
    def forward(self, image_feat, clinical_vector):
        ...
        # Image tokens attend to clinical tokens
